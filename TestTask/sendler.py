...
def send_email(addr_to, msg_subj, msg_text, files):
    addr_from = "zagreev.marat@gmail.com"                         # Отправитель
    password  = "unknown"                                  # Пароль
...
if __name__ == "__main__":
    ...
    addr_to   = "zagreev.marat@gmail.com"                   # Получатель
    files = ['usd_rub.xlsx']                                # Список файлов, если вложений нет, то files=[]

    send_email(addr_to, "Тема сообщения", 'text', files)
